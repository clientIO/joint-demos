 ...
 * for a fork, the button at its right end that adds a branch. Collapsed, it
 * stands in for the group.
 */
export function GroupStartView(): ReactNode {
    const { kind, collapsed } = useCell(selectElementData<GroupStartData>);
    const id = useCellId();
