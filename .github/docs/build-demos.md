...
- [`.github/workflows/build-demos.yml`](../workflows/build-demos.yml) — builds the demos on pushes to `main` (can be called by another repository with its own locally built `@joint/*` packages)
