...
export function layoutFishbone(graph, x, y, options = {}) {
    const { vsGap = 10, vcGap = 12, hsGap = 5, hcGap = 2 } = options, restOptions = __rest(options, ["vsGap", "vcGap", "hsGap", "hcGap"]);
    ...
    const sizeTop = measureNode(graph, tail, topChildren, false, 0, true, Object.assign(Object.assign(Object.assign({}, restOptions), layoutOptions), { top: true }));
    const sizeBottom = measureNode(graph, tail, bottomChildren, false, 0, true, Object.assign(Object.assign(Object.assign({}, restOptions), layoutOptions), { top: false }));
    ...
    positionHorizontalChildren(graph, bottomChildren, tail, xt, yt, 0, Object.assign({ top: false }, layoutOptions));
    positionHorizontalChildren(graph, topChildren, tail, xt, yt, 0, Object.assign({ top: true }, layoutOptions));
...
function measureNode(graph, node, children, horizontal, level = 0, last, options = {}) {
    ...
    if (children.length === 0) {
        return Object.assign({}, node.size());
    }
