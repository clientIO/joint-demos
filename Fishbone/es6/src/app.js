...
export const init = () => {
    ...
    toolbar.render();
    (_a = document.getElementById('toolbar')) === null || _a === void 0 ? void 0 : _a.appendChild(toolbar.el);
    ...
    paper.on('element:pointerclick', (elementView) => {
        ...
        if (level === 0) {
            ...
            inputs[elementPath] = Object.assign(Object.assign({}, elementInputs), { children: childrenInputs });
        }
        ...
        (_a = dialog.el.querySelector('.controls')) === null || _a === void 0 ? void 0 : _a.appendChild(cancelButton);
        ...
        (_b = dialog.el.querySelector('.controls')) === null || _b === void 0 ? void 0 : _b.appendChild(saveButton);
