...
const stencilContainer = document.querySelector('.stencil-container');
const services = {
    ...
    inspectorService: new InspectorService({
        openGroupsButton: document.querySelector('button.open-groups-btn'),
        closeGroupsButton: document.querySelector('button.close-groups-btn'),
...
const app = new KitchenSinkService(document.getElementById('app'), document.querySelector('.paper-container'), services);
app.startRappid();
