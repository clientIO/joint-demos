...
/** The drop points - the add and insert buttons that can take the moved subtree - grow to this while a move is on: easier to hit. The buttons the stylesheet draws grow with `--drop-point-size`, the same size (see `index.css`). */
