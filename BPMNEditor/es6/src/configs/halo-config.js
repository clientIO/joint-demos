...
export const handles = {
    ...
    ConnectTask: Object.assign(Object.assign({}, ui.Halo.getDefaultHandle('fork')), { name: 'connect-task', position: GroupNames.BPMNTools, content: `<span class="${activityIconClasses.TASK}"></span>`, data: {
