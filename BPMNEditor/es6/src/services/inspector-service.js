...
export default class InspectorService {
    ...
    constructor({ inspectorEl, contentButton, appearanceButton }) {
        ...
        this.currentView = InspectorView.CONTENT;
    ...
    canCurrentShapeAccessContentView() {
        var _a;
        const hasMarkers = ((_a = this.currentShape) === null || _a === void 0 ? void 0 : _a.isElement()) && this.currentShape.getMarkers && this.currentShape.getMarkers().length > 0;
