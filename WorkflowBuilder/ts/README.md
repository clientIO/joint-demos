# JointJS+ General Workflow Builder

General Workflow is a JointJS+ demo application that lets you visually design an automation workflow suitable for various domains.
