...
export function changeEdge(json, parentData, childData, edge) {
    ...
    if (index > -1) {
        ...
        parent.to[index] = Object.assign(Object.assign({}, currentEdge), edge);
    }
}
...
export function createNode(data, json, id = util.uuid()) {
    if (!json[id]) {
        const node = Object.assign({ to: [] }, data);
        json[id] = node;
    }
    else {
        json[id] = Object.assign(Object.assign({}, json[id]), data);
    }
    return id;
}
...
export function removeEdgesFromNode(json, id) {
    Object.keys(json).forEach((nodeId) => {
        ...
        if (node === null || node === void 0 ? void 0 : node.to) {
...
export function extractNodesIds(json) {
    ...
    Object.entries(json).forEach(([sourceId, node]) => {
        var _a;
        acc.add(sourceId);
        (_a = node.to) === null || _a === void 0 ? void 0 : _a.forEach(target => {
