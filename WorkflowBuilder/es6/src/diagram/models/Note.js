...
class Note extends Node {
    ...
    getInspectorConfig() {
        return Object.assign(Object.assign({}, super.getInspectorConfig()), { headerText: 'Note', headerHint: 'Add notes for context and collaboration', headerIcon: 'assets/icons/note.svg' });
    }
}
