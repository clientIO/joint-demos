...
class DiagramNode extends Node {
    ...
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { [Attribute.InboundPorts]: [], [Attribute.OutboundPorts]: [], ports: {
                items: [],
                groups: {
    ...
    label: {
        position: {
            ...
            args: {
                ...
                y: 16,
                attrs: {
                    label: Object.assign(Object.assign({}, portLabelAttributes), { textAnchor: 'end' })
                }
            }
        },
