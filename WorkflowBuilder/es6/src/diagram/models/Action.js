...
class Action extends DiagramNode {
    constructor() {
        super(...arguments);
    ...
    updateConfiguration(configuration) {
        ...
        this.attr({
            ...
            label: {
                text: (_a = this.getLabel()) !== null && _a !== void 0 ? _a : actionName
            },
            warningIcon: {
                display: 'none'
            },
    ...
    getInspectorConfig() {
        ...
        const config = {
            headerText: `${(_a = this.configuration) === null || _a === void 0 ? void 0 : _a.action.name}`,
            headerIcon: this.attr('icon/href'),
            headerHint: `${(_b = this.configuration) === null || _b === void 0 ? void 0 : _b.provider.name}`,
            groups: {
                data: {
                    label: 'Data',
                    index: 2
