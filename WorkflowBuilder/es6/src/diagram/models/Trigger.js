...
class Trigger extends DiagramNode {
    constructor() {
        super(...arguments);
    ...
    defaults() {
        const attributes = {
            ...
            attrs: {
                ...
                icon: Object.assign(Object.assign({}, iconAttributes), { x: `calc(w/2 - ${Theme.IconSize / 2})`, y: `calc(h/2 - ${Theme.IconSize / 2})`, href: 'assets/icons/not-configured.svg' }),
                typeLabel: Object.assign(Object.assign({}, nodeTypeLabelAttributes), { x: 'calc(w/2)', y: 'calc(h+15)', textWrap: {
                        width: 150,
                        maxLineCount: 1,
                        ellipsis: true
                    } }),
                label: Object.assign(Object.assign({}, nodeLabelAttributes), { x: 'calc(w/2)', y: 'calc(h+30)', textWrap: {
                        width: 200,
                        maxLineCount: 2,
                        ellipsis: true
                    } }),
    ...
    updateConfiguration(configuration) {
        ...
        this.attr({
            ...
            label: {
                text: (_a = this.getLabel()) !== null && _a !== void 0 ? _a : triggerName
            },
            warningIcon: {
                display: 'none'
            },
    ...
    getInspectorConfig() {
        ...
        return Object.assign(Object.assign({}, super.getInspectorConfig()), { headerText: `${(_a = this.configuration) === null || _a === void 0 ? void 0 : _a.trigger.name}`, headerIcon: this.attr('icon/href'), headerHint: `${(_b = this.configuration) === null || _b === void 0 ? void 0 : _b.provider.name}` });
    }
}
Trigger.type = TYPE;
