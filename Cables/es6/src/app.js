...
export const init = () => {
    ...
    const cellNamespace = Object.assign(Object.assign({}, shapes), { CompositeCable,
        Plug,
        ScrewTerminal });
    ...
    stencil.render();
    (_a = document.getElementById('stencil')) === null || _a === void 0 ? void 0 : _a.appendChild(stencil.el);
