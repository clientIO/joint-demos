...
| `test` | `npm test` | Build every demo into `_site/`, and run the tests of those that have any (stops on first failure) |
...
> [!NOTE]
> `test` requires Bash. On Windows, run it from Git Bash or WSL.
>
