...
export default class PertChart extends mvc.View {
    ...
    initialize() {
        ...
        const cellNamespace = Object.assign(Object.assign({}, shapes), { task: TaskElement, taskView: TaskElementView, dependency: DependencyLink });
        
        const graph = new dia.SearchGraph({}, { cellNamespace });
        
        const paper = new dia.Paper(Object.assign({ model: graph, cellViewNamespace: cellNamespace, drawGrid: true, gridSize: 10 }, paperOptions));
    ...
    onRemove() {
        ...
        (_b = this.navigator) === null || _b === void 0 ? void 0 : _b.remove();
        (_c = this.resourcesStencil) === null || _c === void 0 ? void 0 : _c.remove();
    }
}
