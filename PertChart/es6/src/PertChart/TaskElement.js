...
export class TaskElement extends Record {
    ...
    defaults() {
        return Object.assign(Object.assign({}, super.defaults), { type: 'task', z: 2, size: { width: TASK_WIDTH }, 
            // padding: will be set dynamically based on the assignees
            itemHeight: 30, itemIcon: { width: 16, height: 16, padding: TASK_PADDING }, itemOffset: 0, attrs: util.defaultsDeep({
                root: {
                    magnetSelector: 'body',
                    cursor: 'pointer',
                },
