...
export const defaultAnchor = (view, magnet, refPoint, options, endType, linkView) => {
    const anchor = anchors.midSide.call(linkView, view, magnet, refPoint, Object.assign(Object.assign({}, options), { mode: 'horizontal', padding: endType === 'source' ? LINK_SOURCE_ANCHOR_OFFSET : LINK_TARGET_ANCHOR_OFFSET }), endType, linkView);
    return anchor;
};
