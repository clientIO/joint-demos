...
export function extractTasks(rawTasks, data, options = {}) {
    ...
    rawTasks.forEach(task => {
        ...
        const assignees = (data.assignments[id] || []).map(resourceId => {
            var _a;
            return (_a = data.resources[resourceId]) !== null && _a !== void 0 ? _a : null;
        }).filter(Boolean);
        const currentTask = {
            id,
            name,
        ...
        const childrenTasks = extractTasks(children, data, Object.assign(Object.assign({}, options), { childrenDependencies: true }));
