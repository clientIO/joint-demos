...
export function openInspector(app, model, { openGroupName } = {}) {
    ...
    const _a = model.getInspectorConfig(), { groups, inputs, headerText = '', headerIcon = '', headerIconBackground = '', headerHint = '' } = _a, inspectorOptions = __rest(_a, ["groups", "inputs", "headerText", "headerIcon", "headerIconBackground", "headerHint"]);
    ...
    const inspector = ui.Inspector.create(inspectorEl, Object.assign(Object.assign({}, inspectorOptions), { stateKey: () => model.id.toString(), cell: diagramData, multiOpenGroups: false, 
        // Non-labeled nodes have multiple groups that should be tracked
        storeGroupsState: !isLabeledNode, restoreGroupsState: !isLabeledNode, groups, inputs: {
...
export function closeInspector(app) {
    ...
    (_a = ui.Inspector.instance) === null || _a === void 0 ? void 0 : _a.storeGroupsState();
