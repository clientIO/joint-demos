...
export default class SimplifiedNodeView extends dia.ElementView {
    ...
    update() {
        ...
        body === null || body === void 0 ? void 0 : body.setAttribute('d', model.getOutlinePathData());
        body === null || body === void 0 ? void 0 : body.setAttribute('fill', model.getMinimapBackground());
    }
}
