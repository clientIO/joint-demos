...
class Note extends Node {
    constructor() {
        ...
        this.minimapBackground = Theme.NoteMinimapBackgroundColor;
    }
    ...
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { 
            ...
            [Attribute.Removable]: true, [Attribute.Selectable]: true, [Attribute.ContextMenu]: {
            ...
            [Attribute.Markdown]: '', 
            // JointJS attributes
            z: -1, type: TYPE, size: { width: 200, height: 80 }, attrs: {
                root: {
                    cursor: 'move',
                },
                body: {
     ...
     */
    getInspectorConfig() {
        return Object.assign(Object.assign({}, super.getInspectorConfig()), { headerText: 'Notes', headerIcon: 'assets/icons/note.svg', headerHint: 'Add notes for context and collaboration' });
    }
    
    getOutlinePathData(options) {
        return super.getOutlinePathData(Object.assign({ radius: 8 }, options));
    }
}
