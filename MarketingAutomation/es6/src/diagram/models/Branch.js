...
class Branch extends LabeledNode {
    constructor() {
        super(...arguments);
        
        this.minimapBackground = Theme.BranchMinimapBackgroundColor;
    }
    ...
    defaults() {
        const attributes = {
            ...
            attrs: {
                ...
                iconBackground: Object.assign(Object.assign({}, iconBackgroundAttributes), { fill: Theme.BranchIconBackgroundColor }),
