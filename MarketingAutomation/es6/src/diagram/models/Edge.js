    ...
    defaults() {
        const attributes = {
            ...
            defaultLabel: {
                ...
                attrs: {
                    labelText: Object.assign(Object.assign({}, edgeLabelAttributes), { fill: Theme.EdgeLabelColor, textAnchor: 'middle', textVerticalAnchor: 'middle', pointerEvents: 'none' }),
                    labelBody: {
                        ref: 'labelText',
