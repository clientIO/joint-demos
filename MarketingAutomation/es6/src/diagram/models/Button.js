    ...
    defaults() {
        const attributes = {
            ...
            attrs: {
                ...
                body: Object.assign(Object.assign({}, buttonBodyAttributes), { magnet: true, cx: 'calc(s/2)', cy: 'calc(s/2)' }),
                icon: Object.assign(Object.assign({}, buttonIconAttributes), { transform: `translate(calc(s/2), calc(s/2))` })
            }
        };
