...
class Action extends LabeledNode {
    constructor() {
        super(...arguments);
    ...
    defaults() {
        const attributes = {
            ...
            attrs: {
                ...
                icon: Object.assign(Object.assign({}, iconAttributes), { href: 'assets/icons/empty-trigger.svg' }),
    ...
    updateProvider(provider, action) {
        ...
        this.attr({
            ...
            iconBackground: {
                fill: iconBackground !== null && iconBackground !== void 0 ? iconBackground : Theme.IconBackgroundColor
            },
            label: {
                text: (_a = this.getLabel()) !== null && _a !== void 0 ? _a : name
            },
            typeLabel: Object.assign(Object.assign({}, typeLabelAttributes), { text: name })
        });
        
        this.dataDefinition = data;
        this.minimapBackground = minimapBackground !== null && minimapBackground !== void 0 ? minimapBackground : Theme.NodeMinimapBackgroundColor;
    }
