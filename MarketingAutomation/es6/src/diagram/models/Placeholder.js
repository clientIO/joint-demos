    ...
    defaults() {
        const attributes = {
            ...
            attrs: {
                ...
                buttonBody: Object.assign(Object.assign({}, buttonBodyAttributes), { cx: 'calc(w / 2)', cy: 'calc(h / 2)' }),
                buttonIcon: Object.assign(Object.assign({}, buttonIconAttributes), { transform: `translate(calc(w/2), calc(h/2))` })
            }
        };
