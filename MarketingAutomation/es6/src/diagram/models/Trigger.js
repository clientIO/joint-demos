...
class Trigger extends Node {
    constructor() {
        ...
        this.minimapBackground = Theme.TriggerMinimapBackgroundColor;
        
        this.criteriaDataDefinitions = {};
    }
    ...
    defaults() {
        ...
        const attributes = {
            ...
            attrs: {
                ...
                iconBackground: Object.assign(Object.assign({}, iconBackgroundAttributes), { fill: Theme.TriggerIconBackgroundColor }),
                icon: Object.assign(Object.assign({}, iconAttributes), { href: 'assets/icons/trigger.svg' }),
                typeLabel: Object.assign(Object.assign({}, typeLabelAttributes), { text: 'Trigger enrollment for contacts', textWrap: {
                        width: `calc(w - ${Theme.NodeHorizontalPadding * 2 + Theme.IconBackgroundSize + Theme.IconLabelSpacing})`,
                        maxLineCount: 1,
                        ellipsis: true
                    } }),
                label: Object.assign(Object.assign({}, nodeLabelAttributes), { text: 'When this happens', textWrap: {
                        width: `calc(w - ${Theme.NodeHorizontalPadding * 2 + Theme.IconBackgroundSize + Theme.IconLabelSpacing})`,
                        maxLineCount: 1,
                        ellipsis: true
                    } }),
    ...
    getInspectorConfig() {
        ...
        return Object.assign(Object.assign({}, super.getInspectorConfig()), { headerText: `Trigger`, headerIcon: this.attr('icon/href'), headerIconBackground: this.attr('iconBackground/fill'), headerHint: 'Configure automation rules', groups,
            inputs });
    }
