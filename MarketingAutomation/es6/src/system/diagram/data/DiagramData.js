...
export default class DiagramData extends mvc.Model {
    ...
    startBatch(batchName, options = {}) {
        this.trigger('batch:start', Object.assign(Object.assign({}, options), { batchName }));
    }
    
    stopBatch(batchName, options = {}) {
        this.trigger('batch:stop', Object.assign(Object.assign({}, options), { batchName }));
    }
