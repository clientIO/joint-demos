...
export default class Navigator {
    ...
    renderToolbar() {
        ...
        const zoomOptions = Object.assign({ min: 0.1, max: 3, step: 10 }, zoom);
    ...
    renderMinimap() {
        ...
        const minimap = new ui.Navigator({
            ...
            dynamicZoom: true,
            paperOptions: Object.assign(Object.assign({}, this.options.paperOptions), { async: true, autoFreeze: true, overflow: true, defaultConnectionPoint: {
                    name: 'rectangle',
                    args: { useModelGeometry: true }
                }, defaultAnchor: {
                    name: 'perpendicular',
                    args: { useModelGeometry: true }
                }, viewManagement: true, background: {
                    color: 'transparent'
                } })
        });
    ...
    isMinimapVisible() {
        var _a;
        return !((_a = this.minimap) === null || _a === void 0 ? void 0 : _a.el.classList.contains('hidden'));
    }
