# Chatbot (React Typescript) <a href="https://www.jointjs.com/jointjs-plus"><img src="../../_assets/jointjs-plus-badge.svg" alt="JointJS+" width="123" align="right" /></a>
...
```bash
joint download chatbot/react-ts
```
